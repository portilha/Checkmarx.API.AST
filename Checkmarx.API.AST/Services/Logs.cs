...
namespace Checkmarx.API.AST.Services.Logs
{
    ...
    {
        private string _baseUrl = "/api/logs";
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;

        public Logs(System.Net.Http.HttpClient httpClient)
        {
        ...
        /// <summary>
        /// Create a pre-signed URL to be used to download engine log file
        /// </summary>
        ...
        public virtual async System.Threading.Tasks.Task<string> GetEngineLogsAsync(System.Guid scan_id, string engine, string? authorization = null, System.Guid? correlationId = null, string? accept = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (scan_id == null)
            ...
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/{scan-id}/{engine}");
            ...
            urlBuilder_.Replace("{engine}", System.Uri.EscapeDataString(ConvertToString(engine, System.Globalization.CultureInfo.InvariantCulture)));
