...
namespace Checkmarx.API.AST.Services.SASTMetadata
{
    ...
    public partial class SASTMetadata
    {
        private string _baseUrl = "/api/sast-metadata";
        ...
        public virtual async System.Threading.Tasks.Task<ScanInfoCollection> GetMetadataFromMultipleScansAsync(System.Collections.Generic.IEnumerable<System.Guid> scan_ids, string authorization = null, System.Guid? correlationId = null, string accept = null,  System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (scan_ids == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ScanInfoCollection>(response_, headers_, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="accept">API version should be appended to this header</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ScanInfo> GetMetadataAsync(System.Guid scan_id, string authorization = null, System.Guid? correlationId = null, string accept = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (scan_id == null)
                throw new System.ArgumentNullException("scan_id");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/{scan-id}");
        ...
        /// <param name="correlationId">correlation id to keep track of a flow if many APIs are involved</param>
        /// <param name="accept">API version should be appended to this header</param>
        /// <returns>The engine metrics for the provided scan</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<Metrics> MetricsAsync(System.Guid scan_id, string authorization = null, System.Guid? correlationId = null, string accept = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (scan_id == null)
                throw new System.ArgumentNullException("scan_id");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/{scan-id}/metrics");
            urlBuilder_.Replace("{scan-id}", System.Uri.EscapeDataString(ConvertToString(scan_id, System.Globalization.CultureInfo.InvariantCulture)));
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 401)
                        {
                            ...
                            throw new ApiException("Access token is missing or invalid", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 404)
                        {
    ...
    public partial class ScanInfo
    {
        ...
        [Newtonsoft.Json.JsonProperty("isIncrementalCanceled", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public bool IsIncrementalCanceled { get; set; }

        [Newtonsoft.Json.JsonProperty("incrementalCancelReason", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string IncrementalCancelReason { get; set; }

        [Newtonsoft.Json.JsonProperty("baseId", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string BaseId { get; set; }

        [Newtonsoft.Json.JsonProperty("addedFilesCount", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int AddedFilesCount { get; set; }

        [Newtonsoft.Json.JsonProperty("changedFilesCount", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int ChangedFilesCount { get; set; }

        [Newtonsoft.Json.JsonProperty("deletedFilesCount", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int DeletedFilesCount { get; set; }

        [Newtonsoft.Json.JsonProperty("changePercentage", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public float ChangePercentage { get; set; }

        [Newtonsoft.Json.JsonProperty("queryPreset", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string QueryPreset { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.15.10.0 (NJsonSchema v10.6.10.0 (Newtonsoft.Json v12.0.0.0))")]
    public partial class ScanInfoCollection
    {
        /// <summary>
        /// The number of records matching the applied filter.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("totalCount", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int TotalCount { get; set; }

        /// <summary>
        /// Scans of that specific group.
        /// </summary>
        ...
        public System.Collections.Generic.ICollection<ScanInfo> Scans { get; set; }

        /// <summary>
        /// List of scan ids that wasn't found.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("missing", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<System.Guid> Missing { get; set; }
    ...
    public partial class Anonymous
    {
        ...
        [Newtonsoft.Json.JsonProperty("partiallyGoodFiles", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double PartiallyGoodFiles { get; set; }

        [Newtonsoft.Json.JsonProperty("badFiles", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double BadFiles { get; set; }
